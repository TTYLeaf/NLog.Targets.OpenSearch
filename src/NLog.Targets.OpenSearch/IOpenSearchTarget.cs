...
{
    /// <summary>
    /// Interface for NLog Target for writing to OpenSearch
    /// </summary>
    public interface IOpenSearchTarget
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets the OpenSearch cloud id.
        ...
        /// <summary>
        /// Gets or sets an alertnative serializer for the OpenSearch client to use.
        /// </summary>
        IOpenSearchSerializer OpenSearchSerializer { get; set; }

        /// <summary>
        /// Gets or sets the OpenSearch ApiKeyId.
        /// <para>Use with <see cref="ApiKey"/> and <see cref="CloudId"/>.</para>
        /// </summary>
        string ApiKeyId { get; set; }

        /// <summary>
        /// Gets or sets the OpenSearch ApiKey.
